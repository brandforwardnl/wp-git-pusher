...
class Github_API {
     ...
     * @param string $owner Repository owner.
     * @param string $name  Repository name.
     * @return bool|WP_Error Returns true if private, false if public, WP_Error on failure.
     */
    public function is_repository_private($owner, $name) {
        $result = $this->request('/repos/' . $owner . '/' . $name);
        ...
        return isset($result['private']) && $result['private'] === true;
    }
