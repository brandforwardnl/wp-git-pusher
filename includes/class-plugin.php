...
class Plugin {
    ...
    public function init() {
        ...
        if (is_admin()) {
            $this->admin = new Admin($this->repository_manager, $this->github_api, $this->updater, $this->logger, $this->licensing ?? null, $this->license_settings ?? null);
            $this->admin->init();
        }
    ...
    public function init_licensing() {
        ...
        $this->licensing = $licensing_instance->register(array(
            'basename'      => GITHUB_PUSH_PLUGIN_BASENAME,
            'version'       => GITHUB_PUSH_VERSION,
            'api_url'       => 'https://coderz.store',
        ...
        $license_settings_instance = new LicenseSettings();
        $this->license_settings = $license_settings_instance->register($this->licensing, array(
        ...
        if ($this->license_settings) {
            $this->license_settings->addPage(array(
                'type'        => 'submenu',
                'parent_slug' => 'github-push',
