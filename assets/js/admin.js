...
(function($) {
    ...
    $(document).ready(function() {
        ...
        function renderReposList(repos) {
            ...
            var hasValidLicense = githubPush.hasValidLicense || false;
            var purchaseUrl = githubPush.purchaseUrl || 'https://coderz.store';
            ...
            repos.forEach(function(repo) {
                ...
                // Check if it's a private repo and license is invalid
                if (repo.private && !hasValidLicense) {
                    html += '<td><a href="' + escapeHtml(purchaseUrl) + '" target="_blank" class="button button-small button-primary" style="background-color: #0073aa;">' + escapeHtml(githubPush.strings.upgradeForPrivate) + '</a></td>';
                } else {
